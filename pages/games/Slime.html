...
<head>
    ...
    <title>Tensei Shitara Slime Data Ken</title>
    ...
    class="snap-y snap-mandatory relative w-full h-screen overflow-y-auto overflow-x-hidden scroll-smooth text-slate-300 ">
      <section class="snap-center h-screen">
        <div class="h-screen p-40 flex">
          ...
          <div class="absolute inset-0 flex items-center justify-center flex-col gap-4">
            <h1 class="text-3xl">Tensei Shitara Slime Data Ken</h1>
      ...
      <section class="snap-center h-screen">
        <div class="h-screen p-40 flex flex-row gap-6">
          <img src="../../img/tssdk/vertical.jpg" alt="img" class="object-cover">
          <div class="info flex flex-col gap-2">
            <h1 class="text-3xl">Tensei Shitara Slime Data Ken</h1>
            <p>
              
"Tensei Shitara Slime Data Ken" te sumerge en un mundo mágico donde encarnas a Satoru Mikami, un asalariado promedio reencarnado como un slime. Explora un vasto mundo abierto lleno de desafíos y secretos, forja alianzas con criaturas únicas, y domina un sistema de combate estratégico en tiempo real. Tus decisiones afectarán el destino de la Tierra de los Monstruos. ¿Serás un héroe o un líder astuto? Este emocionante juego de rol combina una narrativa épica, un mundo vibrante y un emocionante sistema de combate. ¡Prepárate para vivir una aventura inolvidable como el slime más poderoso del mundo!  
            </p>
        </div>
        </div>
      </section>      
