    ...
    class="snap-y snap-mandatory relative w-full h-screen overflow-y-auto overflow-x-hidden scroll-smooth text-slate-300 ">
      <section class="snap-center h-screen">
        <div class="h-screen p-40 flex">
          <img src="../../img/jk/jujutsu.gif" alt="img" class="object-cover rounded-md">
          <div class="absolute inset-0 flex items-center justify-center flex-col gap-4">
            <h1 class="text-3xl">Jujutsu Kaisen</h1>
      ...
      <section class="snap-center h-screen">
        <div class="h-screen p-40 flex flex-row gap-6">
          <img src="../../img/jk/jujutsu.png" alt="img" class="object-cover">
          <div class="info flex flex-col gap-2">
            <h1 class="text-3xl">Jujutsu Kaisen</h1>
            <p>
              En "Jujutsu Kaisen" uno se adentra en un mundo de fantasía en el que encontrar toda clase de espectaculares batallas. Esencialmente, el conflicto que mueve este mundo es el que pone a hechiceros o chamanes contra maldiciones, una especie de espíritus corrompidos que se mantienen en el mundo de los vivos aterrorizando y cobrándose la vida de humanos. En el epicentro de todo esto conocemos a Yuji Itadori, un adolescente completamente normal hasta que un día devora uno de los dedos de Sukuna, conocido como el rey de las maldiciones. Esto provoca que Sukuna 'despierte' en su interior, y hace que la vida de Itadori cambie por completo: deberá entrenar como hechicero y ayudar a encontrar todos los dedos restantes que quedan de esta maldición para evitar que otras maldiciones los utilicen por tal de aumentar su poder, pero sobre todo para prevenir que Sukuna acabe reviviendo en el mundo de los vivos.
            </p>
        </div>
        </div>
      </section>      
