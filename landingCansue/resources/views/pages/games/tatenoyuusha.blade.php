...
<main 
    class="snap-y snap-mandatory relative w-full h-screen overflow-y-auto overflow-x-hidden scroll-smooth text-slate-300 ">
      ...
      <div class="h-screen p-10 flex my-10 flex-col items-center gap-2">
          <h1 class="text-5xl">Tate No Yuusha</h1>
          <video src="{{asset('img/tny/intro.mp4')}}" loop autoplay muted class="object-cover object-center w-[90%] h-[80%]"></video>
      ...
      <div class="h-screen pl-40 pt-20 pb-40 pr-40 flex flex-row gap-6" >
          <img src="{{asset('img/tny/vertical.png')}}" alt="img" class="object-cover">
          <div class="info flex flex-col gap-2">
            <h1 class="text-5xl">Tate No Yuusha</h1>
            <p class="text-2xl text-justify">
			Los Cuatro Héroes Cardinales son un grupo de hombres comunes del Japón moderno convocados al reino de Melromarc para convertirse en sus salvadores. Melromarc es un país azotado por las Olas de la Catástrofe que han devastado repetidamente la tierra y traído desastres a sus ciudadanos durante siglos. Los cuatro héroes reciben respectivamente una espada, una lanza, un arco y un escudo para vencer estas olas. Naofumi Iwatani, un otaku, es maldecido con el destino de ser el "Héroe del Escudo". Armado con solo un mísero escudo, Naofumi es menospreciado y ridiculizado por sus compañeros héroes y la gente del reino debido a sus débiles capacidades ofensivas y su personalidad mediocre.
            </p>
        </div>
        </div>
      </section>      
      ...
      <section class="snap-center h-screen w-screen flex">
        <div class="h-screen pl-40 flex flex-row pr-20">
            <div class="flex flex-col ml-10 gap-10">
              ...
              <form action="/games/TateNoYuusha" method="POST" class="flex flex-col text-white pb-2">
                  @csrf
                  @auth
                  Nombre:
                  ...
                  <input type="hidden" name="game" value="TateNoYuusha">
